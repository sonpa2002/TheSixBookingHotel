...
namespace DatKhachSan.Controllers
{
    public class BookingController : Controller
    {
        ...
        [HttpPost]
        public IActionResult GetBookingsWithRole([FromBody] SearchModel searchModel)
        {
            ...
            {
                return BadRequest(new { success = false, message = "Xin lỗi! Bạn không có quyền thao tác chức năng này :(" });
            }
        }
